...
The image generated by this setup is available at https://hub.docker.com/repository/docker/vcgalpin/xps_dcc_app/
...
```
**Note:** This image does *not* provide the functionality of `run-web-shell.sh`. This functionality can only be accessed when building the image from the Dockerfile rather than just running the downloaded image.
